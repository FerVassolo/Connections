package com.example.connections.security
...
@HiltViewModel(assistedFactory = SecurityViewModel.SecurityViewModelFactory::class)
class SecurityViewModel @AssistedInject constructor(
    ...
    @AssistedFactory
    interface SecurityViewModelFactory {
        fun create(context: Context): SecurityViewModel
    }
}